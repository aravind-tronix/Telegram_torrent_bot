...
telegram_username = (
    "Contact admin @your_telegram_user_name"  # replace with your username
)
...
def welcome(chatid):
    ...
    my_bot().send_message(chatid, welcome, reply_markup=markup)
...
def read_me(chatid):
    readme = f"""Welcome to Torrent Bot. Here are some clarifications\n\n
            ...
            {telegram_username}
            """
    my_bot().send_message(chatid, readme, parse_mode=telegram.ParseMode.HTML)
...
def privacy(chatid):
    privacy = f"""Welcome to Torrent Bot. Our privacy policy\n\n
            ...
            {telegram_username}
            """
    my_bot().send_message(chatid, privacy, parse_mode=telegram.ParseMode.HTML)
...
def terms(chatid):
    terms = f"""Welcome to Torrent Bot. Terms of use\n\n
            ...
            {telegram_username}
            """
    my_bot().send_message(chatid, terms, parse_mode=telegram.ParseMode.HTML)
